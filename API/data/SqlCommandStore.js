class SqlCommandStore {
    constructor() {
        ...
        this.GetAllActiveMatch = `SELECT * FROM tbl_player_match WHERE STATUS = 1`;

        this.GetAllMatches = `SELECT * FROM tbl_player_match`
    }
}
exports.SqlCommandStore = SqlCommandStore;
